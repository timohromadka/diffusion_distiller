...
commands = [
    ...
    "python inference.py --module cifar10_model --name cifar10_exp --batch_size 64 --num_workers 4 --num_fid_samples 5000 --num_images_to_log 16 --checkpoint_path ./checkpoints/cifar10_exp/8_4_sf2/checkpoint_1000.pt --dname 8_4_sf2_inference --sampling_timesteps 1 2 4",
    "python inference.py --module cifar10_model --name cifar10_exp --batch_size 64 --num_workers 4 --num_fid_samples 5000 --num_images_to_log 16 --checkpoint_path ./checkpoints/cifar10_exp/4_2_sf2/checkpoint_1000.pt --dname 4_2_sf2_inference --sampling_timesteps 1 2",
    "python inference.py --module cifar10_model --name cifar10_exp --batch_size 64 --num_workers 4 --num_fid_samples 5000 --num_images_to_log 16 --checkpoint_path ./checkpoints/cifar10_exp/2_1_sf2/checkpoint_1000.pt --dname 2_1_sf2_inference --sampling_timesteps 1",
