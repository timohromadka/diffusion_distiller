# Definition of a VAE class
# Taken from csinva's github repository:
# https://github.com/csinva/gan-vae-pretrained-pytorch/blob/master/mnist_vae/vae.py
#
# All credit goes to csinva for this code
